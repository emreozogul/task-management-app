...
const DocumentEditor = () => {
    ...
    if (isLoading) {
        return (
            <div className="min-h-[calc(100vh-4rem)] bg-[#1a1b23] flex items-center justify-center">
                <svg className="animate-spin h-8 w-8 text-[#6775bc]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] bg-[#1a1b23] px-2 sm:px-6 py-4 sm:py-6 space-y-4">
            <DocumentHeader
